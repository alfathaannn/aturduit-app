...
export const translations = {
    id: {
        ...
        appDesc: 'Aplikasi manajemen keuangan pribadi untuk membantu mengelola pengeluaran, pemasukan, dan tujuan finansial dengan mudah dan efisien.',
        ...
        backupDesc: 'Unduh seluruh data keuangan Anda dalam format JSON untuk keperluan cadangan atau pemindahan perangkat.',
        backupSuccessTitle: 'Backup Selesai',
        backupSuccessDesc: 'File backup telah disimpan. Simpan file ini di tempat yang aman.',
        
        restoreTitle: 'Pulihkan Data',
        restoreDesc: 'Kembalikan data keuangan Anda dari file cadangan JSON yang valid. Tindakan ini akan menggabungkan data.',
        ...
        resetDesc: 'Hapus seluruh data transaksi, kantong, dan pengaturan secara permanen. Tindakan ini tidak dapat dikembalikan.',
        ...
        editPocketTitle: 'Ubah Nama Kantong',
        ...
        swalResetText: 'Tindakan ini akan menghapus seluruh data transaksi, kantong, dan preferensi Anda secara permanen. Data yang hilang tidak dapat dikembalikan.',
        ...
        swalRestoreText: 'Data saat ini akan digabungkan atau ditimpa dengan data dari file backup. Pastikan file backup valid.',
        ...
        swalBackupText: 'Simpan salinan data keuangan Anda ke penyimpanan lokal perangkat ini.',
        swalBackupConfirm: 'Ya, Download Backup',
        
        swalBackupSuccessTitle: 'Backup Selesai',
        swalBackupSuccessText: 'File backup telah disimpan. Simpan file ini di tempat yang aman.',
    ...
    en: {
        // Build & Meta
        appTitle: 'Aturduit App',
        appDesc: 'Personal financial management app to help manage expenses, income, and financial goals easily and efficiently.',
        copyright: '© 2026 by alfathaannn',
        ...
        // Settings
        backupTitle: 'Backup Data',
        backupDesc: 'Download all your financial data in JSON format for backup or device migration.',
        restoreTitle: 'Restore Data',
        restoreDesc: 'Restore your financial data from a valid JSON backup file. This will merge the data.',
        resetTitle: 'Reset App',
        resetDescCard: 'Permanently delete all transaction data, pockets, and settings. This action cannot be undone.',
        ...
        resetTitle: 'Reset App?',
        resetDesc: 'This action will permanently delete all your transactions, pockets, and preferences. Lost data cannot be recovered.',
        resetSuccessTitle: 'Reset Successful',
        resetSuccessDesc: 'App has been reset to initial settings.',
        
        restoreTitle: 'Restore Data?',
        restoreDesc: 'Current data will be merged or overwritten with data from backup file. Ensure backup file is valid.',
        restoreSuccessTitle: 'Restore Successful',
        restoreSuccessDesc: 'Your financial data has been successfully restored.',
        
        backupTitle: 'Backup Data?',
        backupDesc: 'Save a copy of your financial data to this device\'s local storage.',
